      ...
      <div className="about-container">
        <div className="left-column">
          ...
          <p>
            ...
            opportunity to <strong>connect with others</strong>, share cultures,
            and create lasting memories.{" "}
          </p>
          <p>
            {" "}
            By facilitating connections between hosts and guests, our app
            promotes cultural exchange and fosters a sense of community. Through
            the shared experience of a home-cooked meal, people can learn about
            different cuisines, traditions, and stories from around the world.
            We believe that these interactions contribute to a more inclusive
